            ...
            <div className='w-[100%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[2rem] h-[100%] items-center'>
                <div>
                    ...
                    <p className='mt-[1.5rem] text-[18px] text-[#ffffff92]'>
                        Hey there, a BSc CSIT student from Nepal with a passion for frontend development, Python, machine learning, and data structures. My skills include creating dynamic, responsive websites and developing machine learning models. I thrive on solving complex problems and am always eager to learn and collaborate.<br/><br/> Explore my portfolio to see my projects and discover what I can bring to the tech community.</p>
                ...
                <div className='w-[340px] h-[340px] hidden bg-[#55e6a5] relative lg:flex items-center justify-center rounded-full'>
                    <img src={require("../../assets/images/profile.png")} alt='user' className='object-cover rounded-full' />
                </div>
            </div>
